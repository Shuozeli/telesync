...
fn write_test_config(dir: &Path, token: &str, publications: &[(&str, &str)]) {
    ...
    toml_content.push_str(&format!("short_name = \"inttest\"\n"));
    toml_content.push_str(&format!("author_name = \"Integration Test\"\n"));
    toml_content.push_str(&format!("author_url = \"https://example.com\"\n"));
